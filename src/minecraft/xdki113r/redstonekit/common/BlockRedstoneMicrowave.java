...
public class BlockRedstoneMicrowave extends BlockContainer
{
    ...
    protected BlockRedstoneMicrowave(int par1, boolean par2)
    {
    ...
    {
    	//SIDE: 0=SOUTH   1=WEST   2=NORTH   3=EAST
    	//METADATA-facing: 2=SOUTH   5=WEST    3=NORTH   4=EAST
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "redstonekit:MicrowaveFrontOn" : "redstonekit:MicrowaveFront");
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
            ...
            {
                par5EntityPlayer.openGui(RedstoneKit.instance, 1, par1World, par2, par3, par4);
            }
